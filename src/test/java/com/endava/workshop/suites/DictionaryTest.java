...
public class DictionaryTest extends BaseTest{
    ...
    public void reallyBigStringOutputValidation() throws HandlerException {
        Set<String> derivedWords = dictionary.getEnglishWordsFromString(BIG_TEST_WORD,true);
    ...
    public void exceedInputStringLegalLengthOutputValidation() throws HandlerException {
        Set<String> derivedWords = dictionary.getEnglishWordsFromString(dictionary.getRandomStringOfSize(27));
